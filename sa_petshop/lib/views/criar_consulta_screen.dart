...
class _CriarConsultaScreenState extends State<CriarConsultaScreen>{
  ...
  TimeOfDay _selectedTime = TimeOfDay.now(); //não pode selecionar um horário anterior ao horário atual
          ...
          children: [
            ...
            Row(
              children: [
                ...
                TextButton(onPressed: ()=> _dataSelecionada(context), child: Text("Selecionar Hora"))
              ],
            ),
            SizedBox(height: 10,),
            TextFormField(
