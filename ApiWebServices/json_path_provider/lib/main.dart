import 'dart:convert';
import 'dart:io'; //biblioteca para acessar os arquivos do DM
...
class _ProdutoPageState extends State<ProdutoPage>{
  ...
  final TextEditingController _nomeController = TextEditingController();//formulário para nome do produto
  final TextEditingController _valorController = TextEditingController();//formulário para valor do produto

  //carregar as informações do inicio do carregamento do aplicativo
  @override
  void initState(){
    super.initState();
    _carregarProdutos();
  ...
  //métodos para a conexão com a base de dados
